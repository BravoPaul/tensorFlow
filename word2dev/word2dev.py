...
flags = tf.app.flags
flags.DEFINE_string("save_path", "/home/hadoop/tensorFlow_pro/word2dev", "Directory to write the model and "
                    "training summaries.")
flags.DEFINE_string("train_data", "/home/hadoop/tensorFlow_pro/word2dev/text8", "Training text file. "
                    "E.g., unzipped file http://mattmahoney.net/dc/text8.zip.")
flags.DEFINE_string(
    "eval_data", "/home/hadoop/tensorFlow_pro/word2dev/questions-words.txt", "File consisting of analogies of four tokens."
